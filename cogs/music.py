...
class Music(commands.Cog):
    ...
    def search(author, arg):
        ...
        embed = (Embed(title='🎵 Now Playing :', description=f"[{info['title']}]({info['webpage_url']})", color=0x2f3136)
    ...
    @commands.command(brief='!pause', aliases=["resume"])
    ...
    @commands.command(pass_context=True, brief="", aliases=['quit', 'stop'])
...
def setup(bot):
    try:    
        ...
        print(f"Error loading music.py: {e}")